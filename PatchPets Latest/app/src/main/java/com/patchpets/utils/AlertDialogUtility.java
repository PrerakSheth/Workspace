...
public class AlertDialogUtility {
    ...
    public static void showAlertSignup(Context context, String msg, DialogInterface.OnClickListener onYesClick) {
        new AlertDialog.Builder(context).setIcon(0).setTitle(context.getString(R.string.app_name)).setMessage(msg).setCancelable(false).setNeutralButton("OK", onYesClick).show();
    }
    ...
    public static void showConfirmAlertWithNO(Context context, String msg, DialogInterface.OnClickListener onYesClick, DialogInterface.OnClickListener onNoClick) {
        new AlertDialog.Builder(context).setIcon(0).setTitle(context.getString(R.string.app_name)).setMessage(msg).setCancelable(false).setNegativeButton("No", onNoClick)
                .setPositiveButton("Yes", onYesClick).show();
    }
    ...
    public static void showConfirmAlertWithButtonName(Context context, String msg, DialogInterface.OnClickListener onYesClick, String strPositiveButton, String strNegaviteButton) {
        new AlertDialog.Builder(context).setIcon(0).setTitle(context.getString(R.string.app_name)).setMessage(msg).setCancelable(false).setNegativeButton(strNegaviteButton, null)
    ...
    public static void showDeleteAlert(Context context, String msg, DialogInterface.OnClickListener onYesClick) {
        new AlertDialog.Builder(context).setIcon(0).setTitle(context.getString(R.string.app_name)).setMessage(msg).setCancelable(false).setNegativeButton("Cancel", null)
    ...
    public static void showInternetAlert(Context context) {
        new AlertDialog.Builder(context).setIcon(0).setTitle(Constants.STR_INTERNET_ALERT_TITLE).setMessage(Constants.STR_INTERNET_ALERT_MESSAGE)

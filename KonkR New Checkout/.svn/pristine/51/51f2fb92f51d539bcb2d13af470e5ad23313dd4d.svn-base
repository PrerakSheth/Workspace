...
public class FollowersListAdapter extends RecyclerView.Adapter<FollowersListAdapter.ViewHolder> {
    ...
    private ArrayList<FollowersList.FollowersListBean> userSearchListBeans;

    public FollowersListAdapter(Activity context, ArrayList<FollowersList.FollowersListBean> userSearchListBeans) {
    ...
    public FollowersListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_followers_list, parent, false);
        return new FollowersListAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull FollowersListAdapter.ViewHolder holder, final int position) {
        int pos = position;
        final FollowersList.FollowersListBean userList = userSearchListBeans.get(position);

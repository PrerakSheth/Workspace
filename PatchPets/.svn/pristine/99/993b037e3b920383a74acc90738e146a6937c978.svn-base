        ...
        public void ResponseSuccessCallBack(Object object) {
            ...
            if (object != null) {
                ...
                if (response.getStatus() == 1) {
                    ...
                    AlertDialogUtility.showAlert(FavouritesDogActivity.this, response.getMessage(),
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                    Intent intent = new Intent(FavouritesDogActivity.this, SignInActivity.class);
                    ...
                    AlertDialogUtility.showSnakeBar(response.getMessage(), snackBar, FavouritesDogActivity.this);
                }
            }
        }

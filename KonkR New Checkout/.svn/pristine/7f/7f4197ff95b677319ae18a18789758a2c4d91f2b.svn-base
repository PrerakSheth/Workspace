        ...
        switch (v.getId()) {
            ...
            case R.id.tvLikeCount:
                if (Integer.parseInt(tvLikeCount.getText().toString().trim()) > 0) {
                    ...
                    if (goal == 1) {
                        intentExpressopn.putExtra(GlobalData.EXPRESSION, GlobalData.EXPRESSION_GOAL);
                    } else if (inspiring == 1) {
                        intentExpressopn.putExtra(GlobalData.EXPRESSION, GlobalData.EXPRESSION_INSPIRING);
                    } else if (admiring == 1) {
                        intentExpressopn.putExtra(GlobalData.EXPRESSION, GlobalData.EXPRESSION_ADMIRING);
                    }

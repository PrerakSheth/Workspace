...
public class GetReqJsonWithAndroidNetworkingLib extends AsyncTask<String, JSONObject, JSONObject> {
    ...
    public GetReqJsonWithAndroidNetworkingLib(Activity context, JSONObject jsonObject, String url,

...
public class FilterActivity extends AppCompatActivity implements FilterAdapter.OnRemove, View.OnClickListener {
    ...
    private RecyclerView rvBreed, rvAge, rvGender, rvStatus, rvDistance, rvSize;
    private ArrayList<String> breedList, ageList, genderList, statusList, distanceList, sizeList;
    private FilterAdapter breedAdapter, ageAdapter, genderAdapter, statusAdapter, distanceAdapter, sizeOfDogAdapter;
    private TextView tvBreed, tvAge, tvGender, tvStatus, tvDistance, tvSizeOfDog;

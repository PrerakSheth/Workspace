...
//                            tvInstagram.setText(getResources().getString(R.string.link) + " " + getResources().getString(R.string.dexter) + "'s " + getResources().getString(R.string.instagram_account));
                        ...
                        case 9:
                            ...
                            dog.setDogBreed(breedId);
                            dog.setDogSize(dogSize);
                            dog.setDogAge(dogAge);
                            dog.setGender(dogGender);
                            dog.setIsDesexed(dogIsDesexed);
                            dog.setIsWillingToBreed(willingToBreed);
                            dog.setVaccinations(dogVaccinations);
                            dog.setDogDesc(dogDescription);
                            dog.setDogInstaLink(dogInstaLink);

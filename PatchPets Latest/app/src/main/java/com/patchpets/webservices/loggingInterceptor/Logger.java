package com.patchpets.webservices.loggingInterceptor;
...
public class Logger {
    ...
    public static void printJsonResponse(LoggingInterceptor.Builder builder, long chainMs, boolean isSuccessful, int code, String headers, String bodyString) {

...
public class TagsEditText extends AutoCompleteTextView {
    ...
    //        Typeface font = Typeface.createFromAsset(getContext().getAssets(), "/Fonts/Poppins-Bold_1.ttf");
//        setTypeface(font);
    ...
    public void setText(CharSequence text, BufferType type) {
        ...
        Typeface font = Typeface.createFromAsset(getContext().getAssets(), "Fonts/MavenPro-Regular.ttf");

...
public class CardListActivity extends AppCompatActivity implements View.OnClickListener, OnItemClickListener {
    ...
    ResponseCallback responseCallback = new ResponseCallback() {
        ...
        public void ResponseSuccessCallBack(Object object) {
            ...
            if (object != null) {
                CardListResponse response = (CardListResponse) object;
                if (response.getStatus() == 1) {
                    alCards.clear();
                    alCards.addAll(response.getCardList());
                    ...
                    AlertDialogUtility.showAlert(CardListActivity.this, response.getMessage(),
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                    Intent intent = new Intent(CardListActivity.this, SignInActivity.class);
                    ...
                    AlertDialogUtility.showSnakeBar(response.getMessage(), snackBar, CardListActivity.this);
                }
            }
        }
